...
public class PictureUploadPolicy extends DefaultUploadPolicy implements
    ...
    public JPanel createTopPanel(JButton browse, JButton remove,
        ...
        this.rotateLeftButton = new JButton(
                getLocalizedString("buttonRotateLeft"));
        ...
        this.rotateRightButton = new JButton(
                getLocalizedString("buttonRotateRight"));
    ...
    /**
     * @see wjhk.jupload2.policies.DefaultUploadPolicy#getUploadFilename(wjhk.jupload2.filedata.FileData,
     *      int)
     */
    @Override
