...
// Created: 2006-05-04
// Creator: etienne_sf
// Last modified: $Date: 2011-01-20 22:45:42 +0100 (jeu., 20 janv. 2011) $
//
 ...
 * <tr>
 * <tr>
 * <td>fileFilterName</td>
 * <td><i>null</i><br>
 * since 5.0.0</td>
 * Contains the name of the file filter, as it will be displayed in the drop
 * down list of filters, in the file chooser. If this name is given to the
 * applet, it will be returned by the {@link FileFilter#getDescription()}
 * method. <BR>
 * Default value for applet parameter "fileFilterName". This default value let
 * the {@link DefaultUploadPolicy} return a calculated name, which contains the
 * list of allowed file extensions.<BR>
 * Note: this parameter is ignored, if there is no file filter, that is, if the
 * allowedFileExtensions applet parameter is not used.
 * <td>
 * </tr>
 * <tr>
 ...
 * hard drive.
 * <li>The site:samples.java/parseRequest.jsp is a java example of a server page
 ...
 * If set to less than 1 (0 or negative), there is no maximum. This means that all files are uploaded in
 ...
 * <u>Note 6 (security):</u> take care that the full URL is visible, if the user
 * take a look at the page source. So, you should take care when putting login
 * and password there. </td>
 * </tr>
 * <tr>
 ...
 * relevant userAgent header in the specificHeaders applet parameter.</td> </tr>
 * <tr>
 ...
 * </tr>
 * <tr>
 * <td>retryMaxNumberOf</td>
 * <td>1<BR>
 * <i>Since 5.0.0</i></td>
 * <td>Maximum number of retries, that the applet will do, for upload resumable
 * error. A 'upload resumable error', is typically a network error. The default
 * value is 0, to maintain the same behaviour as before.<BR>
 * This maximum of allowed retries is for each packet, that is: if one packet
 * fails two times, and succeed in the third attempt, the next packet will still
 * have up to retryMaxNumberOf retries. For instance, the default value (1),
 * means that the applet will do a one new attempt after a first upload error,
 * for each packet.</td>
 * </tr>
 * <tr>
 * <td>retryNbSecondsBetween</td>
 * <td>30<BR>
 * <i>Since 5.0.0</i></td>
 * <td>The number of seconds, to wait, before trying a new upload of a packet
 * whose upload was in error. This is used if <I>retryMaxNumberOf</I> is 1 or
 * more, and if 'resumable upload error' occurs.</td>
 * </tr>
 * <tr>
 ...
 * since 5.0.0<br>
 * {@link wjhk.jupload2.policies.DefaultUploadPolicy}</td>
 * <td>This parameter indicates whether the applet will send the MD5Sum for
 * uploaded files, or not. If set to true, the MD5Sum is sent in the
 * <I>md5sum</I> HTTP POST argument.</td>
 * </tr>
 * <tr>
 * <td>showLogWindow<br>
 * Since 3.0.2<br>
...
public interface UploadPolicy {
	 ...
	 * method.
	 */
	public final static String PROP_FILE_FILTER_NAME = "fileFilterName";
	...
	/**
	 * Maximum number of retries, that the applet will do, for upload resumable
	 * error. A 'upload resumable error', is typically a network error. The
	 * default value is 0, to maintain the same behaviour as before.
	 */
	public final static String PROP_RETRY_MAX_NUMBER_OF = "retryMaxNumberOf";

	/**
	 * The number of seconds, to wait, before trying a new upload. This is used
	 * if <I>retryMaxNumberOf</I> is 1 or more, and if 'resumable upload error'
	 * occurs.
	 */
	public final static String PROP_RETRY_NB_SECONDS_BETWEEN = "retryNbSecondsBetween";
	...
	/**
	 * Parameter/Property name to spceify whether the md5sum for uploaded file
	 * should be sent.
	 */
	public final static String PROP_SEND_MD5_SUM = "sendMD5Sum";
	...
	/**
	 * Default value for applet parameter "fileFilterName". This default value
	 * let the {@link DefaultUploadPolicy} return a calculated name, which
	 * contains the list of allowed file extensions.
	 * 
	 * @see #PROP_FILE_FILTER_NAME
	 * @see #PROP_ALLOWED_FILE_EXTENSIONS
	 */
	public final static String DEFAULT_FILE_FILTER_NAME = null;
	 ...
	 */
	public final static int DEFAULT_RETRY_MAX_NUMBER_OF = 1;

	/**
	 * Default value for parameter "retryNbSecondsBetween".
	 */
	public final static int DEFAULT_RETRY_NB_SECONDS_BETWEEN = 30;
	 ...
	 */
	public final static boolean DEFAULT_SEND_MD5_SUM = false;
	...
	/**
	 * Indicating that the applet is currently waiting for the user, to select
	 * files or start an uploading.
	 */
	public final static int EXEC_STATUS_READY = 1;
	/** Indicating that the applet is currently uploading files */
	public final static int EXEC_STATUS_UPLOADING = 2;
	 ...
	 * @param remove
	 *            The default removeSelected button.
	 * @param removeAll
	 *            The default removeAll button.
	 * @param mainPanel
	 ...
	 * {@link wjhk.jupload2.policies.DefaultUploadPolicy#createProgressPanel(JProgressBar, JProgressBar, JButton, JButton, JUploadPanel)}
	 * .
	 * 
	 * @param preparationProgressBar
	 *            The default preparation progress bar.
	 * @param uploadProgressBar
	 *            The default upload progress bar.
	 * @param uploadButton
	 *            The default upload button.
	 * @param stopButton
	 *            The default stop button.
	 * @param mainPanel
	 *            The panel that contains all objects.
	 * @return the topPanel, that will be displayed on the top of the Applet.
	 */
	 ...
	 * implementation is defined in
	 * {@link wjhk.jupload2.policies.DefaultUploadPolicy#createStatusBar(JLabel, JUploadPanel)}
	 * .
	 * 
	 * @param statusContent
	 ...
	 * of the components on the applet.<br>
	 * There are some utility methods to style file panel elements (font/color), see
         * {@link wjhk.jupload2.gui.filepanel.FilePanel}.
	 * @param jUploadPanel
	 ...
	 *             The exception is not really an error. It allows an easy way
	 *             to indicates that the applet should stop adding files when
	...
	/**
	 * Reaction to the applet start. This method was added from the patch
	 * 3035735 given by Tsukasa Hamano (SF login: cuspy). Its aim is to move all
	 * call to JSObject from the applet.init() method to the applet.start()
	 * method. This prevents a crash, under Safari.
	 */
	public void start();

	/**
	 * This method is called by the {@link JUploadPanel#updateButtonState()}
	 ...
	 *            One of the EXEC_STATUS_XXX constant.
	 */
	 ...
	 *                indicates that the applet should stop strying adding the
	 *                current file selection. Useful for instance, when a user
	 *                drop a directory, full of unallowed file: it's annoying
	 *                for the user to click 'Ok' for each file in the alert box.
	 */
	 ...
	 *            The directory that will be the current one, the next time the
	 ...
	 * @param currentBrowsingDirectoryParam
	 *            The directory that will be the current one, the next time the
	 *            file chooser is opened. This directory may begin with ~/ or ~\
	 * @see #getCurrentBrowsingDirectory()
	 */
	 ...
	 * 
	 * @return Stored value for fileFilterName
	 ...
	 * 
	 * @return Current value of retryMaxNumberOf
	 */
	 ...
	 * 
	 * @return Current value of retryNbSecondsBetween
	 */
	 ...
	 *            The protocol is set from the postURL. For HTTP URL, a HEAD
	 ...
	 * uploaded. This is interesting, when uploading in chunk mode. But
	 * calculating this can be long, for big files.
	 * 
	 * @return true or false, whether the md5sum should be processed and sent to
	 *         the server.
	 */
	 ...
	 * 
	 * @param sendMD5Sum
	 *            true or false, whether the md5sum should be processed and sent
	 *            to the server.
	 */
	 ...
	 * 
	 * @param fileData
	 *            The file data whose upload file name must be calculated.
	 * @param index
	 *            index of the file in the current request to the server (from 0
	 *            to n)
	 ...
	 * 
	 * @param fileData
	 *            The file data whose upload name must be calculated.
	 * @param index
	 *            index of the file in the current request to the server (from 0
	 *            to n)
	 ...
	 * 
	 * @param dropEvent
	 *            The event containing the dropped file
	 */
	 ...
	 * 
	 * @param reason
	 *            A string describing briefly the problem. The mail subject will
	 *            be something like: Jupload Error (reason)
	 * @param exception
	 *            The java exception that was raised, or null if no exception.
	 */
	 ...
	 * 
	 * @param err
	 *            The erreur message to be displayed. If null the exception (or
	 *            it's cause if any) message is displayed.
	 * @param e
	 *            The exception to report
	 * @param optionType
	 *            One of the valid {@link JOptionPane} option types for the
	 ...
	 * 
	 * @param err
	 *            The erreur message to be displayed.
	 */
	 ...
	 * @param e
	 *            An exception. It's stacktrace is logged.
	 */
	 ...
	 * 
	 * @param info
	 *            The information message that will be displayed.
	 */
	 ...
	 * 
	 * @param sb
	 *            The header {@link ByteArrayEncoder} where specific headers
	 *            should be appended.
	 ...
	 * 
	 * @param status
	 *            The numeric response status (e.g. 200)
	 * @param msg
	 ...
	 * @throws JUploadException
	 *             Thrown if the success conditions are not met.
	 */
	 ...
	 * 
	 * @param e
	 *            null if success, or the exception indicating the problem.
	 * @param serverOutput
	...
	/**
	 * Returns the current locale. It is the default value at startup, based on
	 * the local computer configuration. Then, if the lang applet parameter is
	 * given, this method the Locale initialized from this lang parameter.
	 * 
	 * @return The current Locale for the current policy.
	 */
	 ...
	 * 
	 * @param key
	 *            The key, whose associated text is to retrieve. This text must
	 ...
	 * @param args
	 *            The optional parameters, that will replace the placeholders in
	 *            the localized text identified by 'key'.
	 ...
	 * 
	 * @param str
	 *            The full String that must be displayed to the user.
	 * @see #alert(String)
	 */
	 ...
	 *            The full String that must be displayed to the user.
	 * @param optionTypes
	 *            The options indicating the button to display. Valid options
